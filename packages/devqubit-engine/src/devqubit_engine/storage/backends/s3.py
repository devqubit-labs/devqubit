    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        atexit.register(S3Registry._atexit_close, weak_self)
    ...
    @staticmethod
    def _atexit_close(weak_self: weakref.ref[S3Registry]) -> None:
    ...
    # ------------------------------------------------------------------
    # Metric time-series (local index)
    # ------------------------------------------------------------------
